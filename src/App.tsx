...
import { durationPartsToMinutes, formatDuration, formatPace, minutesToDurationParts, monthSummary, paceMinutesPerKm, parsePace, speedKmPerHour, summarizeWeek } from "./lib/calculations";
